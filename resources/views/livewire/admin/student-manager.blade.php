<div class="flex h-full w-full flex-1 flex-col gap-8 py-8 px-4 md:px-8 max-w-[1200px] mx-auto">
    <div class="flex flex-col gap-1.5">
        <h2 class="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Data Siswa</h2>
        <p class="text-slate-500 dark:text-slate-400 text-sm">Kelola seluruh data siswa secara individu.</p>
    </div>
